...
inf_vaccine_serol_FC_countinf <- read_csv(here::here("Data","inf_vaccine_serol_FC_medianN_medianNvacc.csv"))
...
supp_figure_1e <- ggplot(epi_curve) + 
...
ggsave("supp_fig_1e.png", supp_figure_1e, width = 10, height = 6, dpi=600)
