...
inf_vaccine_serol_FC_countinf <- read_csv(here::here("Data","inf_vaccine_serol_FC_IQR1SN_IQR1Nvacc.csv"))
...
supp_figure_1c <- ggplot(epi_curve) + 
...
ggsave("supp_fig_1c.png", supp_figure_1c, width = 10, height = 6, dpi=600)
