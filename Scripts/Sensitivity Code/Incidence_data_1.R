...
inf_vaccine_serol_FC_countinf <- read_csv(here::here("Data","inf_vaccine_serol_FC_IQR1SN_medianNvacc.csv"))
...
#requires All_visit_serol from data_cleaning.R
...
write.csv(all_inf_data, "all_inf_data_1.csv")
...
supp_figure_1b <- ggplot(epi_curve) + 
...
ggsave("supp_fig_1b.png", supp_figure_1b, width = 10, height = 6, dpi=600)
