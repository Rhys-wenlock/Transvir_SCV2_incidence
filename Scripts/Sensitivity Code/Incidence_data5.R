...
inf_vaccine_serol_FC_countinf <- read_csv(here::here("Data","inf_vaccine_serol_FC_mixtureS_mixtureNvacc.csv"))
...
write.csv(all_inf_data, "all_inf_data_5.csv")
...
supp_figure_1f <- ggplot(epi_curve) + 
...
ggsave("supp_fig_1f.png", supp_figure_1f, width = 10, height = 6, dpi=600)