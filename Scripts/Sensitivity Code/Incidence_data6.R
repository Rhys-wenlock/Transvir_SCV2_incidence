...
inf_vaccine_serol_FC_countinf <- read_csv(here::here("Data","inf_vaccine_serol_FC_mixtureN_mixtureNvacc.csv"))
...
write.csv(all_inf_data, "all_inf_data_6.csv")
...
supp_figure_1g <- ggplot(epi_curve) + 
...
ggsave("supp_fig_1g.png", supp_figure_1g, width = 10, height = 6, dpi=600)