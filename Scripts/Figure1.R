...
#require full_demog_data from data_cleaning.R
...
V1_seroldate$Date <- as.Date(V1_seroldate$Date)
V2_seroldate$Date <- as.Date(V2_seroldate$Date)
V3_seroldate$Date <- as.Date(V3_seroldate$Date)
