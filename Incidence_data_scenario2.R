...
inf_vaccine_serol_FC_countinf <- read_csv("inf_vaccine_serol_FC_IQR1SN_medianNvacc.csv", 
                                          col_types = cols(V1_date = col_date(format = "%Y-%m-%d"), 
                                                           V2_date = col_date(format = "%Y-%m-%d"), 
                                                           V3_date = col_date(format = "%Y-%m-%d")))
...
write.csv(all_inf_data, "all_inf_data_2.csv")
